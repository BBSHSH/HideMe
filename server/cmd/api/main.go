...
func main() {
	...
	api.GET("/app-settings", handlers.GetAppSettings(database))
	api.PUT("/app-settings", middleware.RequireAuth(), middleware.RequireAdmin(), handlers.UpdateAppSettings(database))
